...
@section('main-content')
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <input class="form-control w-75" type="search" id="investor_search"
...
@push('scripts')
<!-- Main page logic for all investor to show n card-->
