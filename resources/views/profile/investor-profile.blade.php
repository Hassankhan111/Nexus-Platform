            ...
            <div class="card mb-4">
                <div class="card-body d-flex justify-content-between align-items-start flex-wrap">
                    <div class="d-flex align-items-center">
                        <img id="inv_image" src="https://via.placeholder.com/100" alt="Investor"
                            class="profile rounded-circle me-2" width="80" height="80">
                        <div>
                            <h2 class="h4 fw-bold mb-1" id="inv_name">John Doe</h2>
                            <p class="text-muted mb-2">
                                <i class="bi bi-building"></i>
                                <span id="inv_company">Investor •</span> <span id="total_inv">12</span>
                                investments
                            </p>
                            <div id="badges">
                                <span class="badge bg-primary" id="inv_location"><i class="bi bi-geo-alt"></i> San Francisco,
                                    CA</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <p id="inv_bio">Entrepreneur passionate about solving fintech problems with AI/ML innovations.</p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between">
                            <span>Team</span>
                            <span class="text-muted" id="team">5 members</span>
                        </div>
